		...
		while(true) {
			...
			case 2 :{
				...
				for (int i = 0; i < b.length; i++) {
					if(b[i]  != null&&b[i].getBookId()==bookId) {
						...
						System.out.println("enter the book name update");
						authorName = sc.next();
			...
			case 4:{
				...
				for ( i = 0; i < b.length; i++) {
				   ...
				   System.out.println("complete searching");
					break;
			}
			...
			case 5: {
				...
				System.out.println("bookId"+"\t"+"authorName"+"\t"+"price");
				  ...
				  System.out.println("all bok are this");
				  break;
			...
			case 7:{
				...
				for (int i = 0; i < b.length; i++) {
					...
					authorName = sc.next();
					System.out.println("update the bok price");
					price = sc.nextInt();
